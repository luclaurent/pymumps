import warnings
import mumps5._dmumps5
import mumps5._smumps5
import mumps5._zmumps5
import mumps5._cmumps5
...
class DMumpsContext(_MumpsBaseContext):
    cast_array = staticmethod(_dmumps5.cast_array)
    _mumps_c = staticmethod(_dmumps5.dmumps5_c)
    _MUMPS_STRUC_C = staticmethod(_dmumps5.DMUMPS_STRUC_C)

class SMumpsContext(_MumpsBaseContext):
    cast_array = staticmethod(_smumps5.cast_array)
    _mumps_c = staticmethod(_smumps5.smumps5_c)
    _MUMPS_STRUC_C = staticmethod(_smumps5.SMUMPS_STRUC_C)

class ZMumpsContext(_MumpsBaseContext):
    cast_array = staticmethod(_zmumps5.cast_array)
    _mumps_c = staticmethod(_zmumps5.zmumps5_c)
    _MUMPS_STRUC_C = staticmethod(_zmumps5.ZMUMPS_STRUC_C)

class CMumpsContext(_MumpsBaseContext):
    cast_array = staticmethod(_cmumps5.cast_array)
    _mumps_c = staticmethod(_cmumps5.cmumps5_c)
    _MUMPS_STRUC_C = staticmethod(_cmumps5.CMUMPS_STRUC_C)
