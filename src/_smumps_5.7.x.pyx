...
__all__ = ['SMUMPS_STRUC_C', 'smumps_c', 'cast_array']

########################################################################
# libsmumps / smumps_c.h wrappers (using Cython)
########################################################################
 
MUMPS_INT_DTYPE = 'i'
DMUMPS_REAL_DTYPE = 'f'
DMUMPS_COMPLEX_DTYPE = 'f'
...
cdef class SMUMPS_STRUC_C:
    ...
    property cntl:
        def __get__(self):
            cdef SMUMPS_REAL[:] view = self.ob.cntl
            return view
    ...
    property rhs_loc:
        ...
        def __set__(self, long value): self.ob.rhs_loc = <SMUMPS_COMPLEX*> value
    ...
    property rinfo:
        def __get__(self):
            cdef SMUMPS_REAL[:] view = self.ob.rinfo
            return view
    property rinfog:
        def __get__(self):
            cdef SMUMPS_REAL[:] view = self.ob.rinfog
            return view
