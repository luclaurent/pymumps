...
setup(
    ...
    ext_modules=[
        Extension(
            ...
            # include_dirs=['/Users/luclaurent/micromamba/envs/py310/include'],
            # library_dirs=['/Users/luclaurent/micromamba/envs/py310/lib/'],
            extra_link_args=['-L/Users/luclaurent/micromamba/envs/py310/lib/','-I/Users/luclaurent/micromamba/envs/py310/include/'],
            libraries=[ 'mumps_common', 'mpiseq'] #'pord', 'metis', 'scotch', 'scotchmetis', 'scotcherr', 'scotcherrexit', 'openblas', 'mpiseq', 'z'],
        ),
        # Extension(
        #     'mumps._smumps',
